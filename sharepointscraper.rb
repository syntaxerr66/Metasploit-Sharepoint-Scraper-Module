...
class Metasploit4 < Msf::Auxiliary
        ...
        def initialize
                super(
                        'Name'        => 'Sharepoint User Enumeration Scanner',
                        'Version'     => '',
                        'Description' => %q{
                                This module scrapes usernames, groups, and detailed employee information
                                 from misconfigured sharepoint sites by looping through all valid IDs 
                                 via a GET request to UserDisp.aspx?ID= and parsing out the relevant
                                 information on the page.
                        },
                        'Author'      => ['syntaxerr66 <chris@erroredsecurity.com>'],
                        'License'     => MSF_LICENSE
                )
